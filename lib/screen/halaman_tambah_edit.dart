    ...
    return Scaffold(
        ...
        actions: <Widget>[
          _isUpdate
              ? IconButton(
                  ...
                  onPressed: () async {
                    //method untuk melakukan delete item, ketika sudah selesai menjalankan maka
                    await service.delBarang(_idBarang).then((value) {
                      if (value.sukses) {
                        //menghapus route sampai .. lalu menjalankan apa
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Form(
            //validasi form apabila nilai tidak sesuai/null
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    //tambahkan validator agar ada warning ketika kosong
                    validator: validator,
                  ),
                ),
                Padding(
